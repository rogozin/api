...
```
 ...
 middle_name | строка или null | отчество
 ...
 phone | объект или null | телефон менеджера
 additional_phone | объект или null | дополнительный телефон менеджера
 ...
 city | строка | код города
 number | строка | телефон
 comment | строка или null | комментарий
