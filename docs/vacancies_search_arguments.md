...
name | string или null | название выбранного параметра, если оно есть, либо `null`
disable_url | string | url поиска вакансий, который получится, если данный параметр убрать
